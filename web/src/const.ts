...
export const URL_UPLOAD = process.env.NODE_ENV === "production" ? "https://ride-api.koon.us/upload/" : `http://${LOCAL_IP}:8080/upload/`
export const URL_GRAPHQL = process.env.NODE_ENV === "production" ? "https://ride-api.koon.us/graphql" : `http://${LOCAL_IP}:8080/graphql`
// export const URL_GRAPHQL = process.env.NODE_ENV === "production" ? "https://ride-api.koon.us/graphql" : "http://192.168.0.166:8080/graphql"
// export const URL_GRAPHQL_WS = process.env.NODE_ENV === "production" ? "wss://ride-api.koon.us/subscriptions" : "ws://localhost:8080/subscriptions"
export const URL_GRAPHQL_WS = process.env.NODE_ENV === "production" ? "wss://ride-api.koon.us/subscriptions" : `ws://${LOCAL_IP}:8080/subscriptions`
